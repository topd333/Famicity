var Cropper = function() {
    ...
    var e = {container_class: "cropper",width: 0,height: 0,min_width: 0,min_height: 0,max_width: 0,max_height: 0,ratio: {width: 0,height: 0}};
    ...
    var n = function() {
        ...
        this.width = Math.round(s.right - s.left), this.height = Math.round(s.bottom - s.top), this.coordinates = {x: 0,y: 0,width: 0,height: 0}, this.moving = this.resizing = this.direction = !1, this.handles = {}, this.overlays = {}, this.wrapImage(), this.attachEventListeners()
    };
    return s.prototype.wrapImage = function() {
        ...
        var t = this, i = "-3px", s = {nw: {left: i,top: i},n: {left: "50%",top: i,marginLeft: i},ne: {right: i,top: i},e: {right: i,top: "50%",marginTop: i},se: {right: i,bottom: i,zIndex: 10},s: {left: "50%",bottom: i,marginLeft: i},sw: {left: i,bottom: i},w: {left: i,top: "50%",marginTop: i}};
        for (var o in s) {
        ...
        var e = {top: {left: 0,top: 0,right: 0,width: "100%"},left: {left: 0},right: {right: 0},bottom: {left: 0,bottom: 0,right: 0,width: "100%"}};
        for (position in e) {
        ...
        if (t.className == this.options.container_class + "-area-handle")
            return;
        ...
        return e = r(e), {x: Math.round(e.clientX - t.left),y: Math.round(e.clientY - t.top)}
    }, s
}();
