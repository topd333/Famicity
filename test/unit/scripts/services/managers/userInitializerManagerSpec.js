describe('userInitializerManager', function() {
  'use strict';

  var $rootScope;
  var userInitializerManager;
  ...
  _pubsub_, _PUBSUB_) {
    ...
    userInitializerManager = _userInitializerManager_;
  ...
  it('enables user, chat, popups and push', function() {
    ...
    userInitializerManager.initialize().then(function() {});
